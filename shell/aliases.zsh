...
# Note: 'code' and 'cursor' commands are wrapped by brew-wrap for extension management
# Use these aliases if you just want to open the apps without brew-wrap integration
